...
curl -LJO $CATS && sleep 2 && unzip Catseye.zip && sleep 2 && cd Catseye && cp -p satellites.xml /$BODIR && rm -rf *.xml && cp -p * /$BODIR
...
echo 
 ...
 2 ) curl -LJO https://github.com/oe-alliance/oe-alliance-settings/archive/master.zip
